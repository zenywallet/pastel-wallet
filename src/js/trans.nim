...
addTranslation(Language.jaJP, "Input your passphrase", "パスフレーズ入力")
...
addTranslation(Language.jaJP, "Unsupported seed card was scanned.", "サポートしていないシードカードを読み取りました。")
...
addTranslation(Language.jaJP, "Failed to unlock. Camera error. Please connect the camera and reload the page.", "ロック解除に失敗しました。 カメラが利用できませんでした。 カメラを接続してページをリロードしてください。")
addTranslation(Language.jaJP, "Camera error. Please connect the camera and reload the page.", "カメラが利用できませんでした。 カメラを接続してページをリロードしてください。")
